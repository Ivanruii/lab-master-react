...
import { Grid, Card, CardMedia, CardContent, Typography, CircularProgress, Button } from '@mui/material';
...
export const RickyMortyList: React.FC = () => {
    const { characterName, page } = useContext(CharacterContext);

    const { data: characters, isLoading } = useQuery<Character[]>(['characters', characterName, page], async () => {
